...
const projects = [
  ...
  },
  {
    ...
    description:
      "A Web and PC based matching game that tests player memory. Used as an Educative Aid for Kids to help sharpen their memory and teach them about Earth and Space.",
    tags: [
      {
        name: "HTML",
        color: "blue-text-gradient",
